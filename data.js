...
window.QUIZ_DATA = {
  ...
  questions: [
    ...
    {"id":"S-01","ch":1,"topic":"Cyber Kill Chain","src":"0 課前基本認識（資安框架）","core":false,"diff":2,"supp":true,"kind":"supplement","q":"「網路攻擊鏈 (Cyber Kill Chain)」描述攻擊者的階段流程，其中『第一個階段』是什麼？","options":["偵蒐 (Reconnaissance)：蒐集目標的相關資訊","武器化 (Weaponization)：製作惡意載荷","橫向移動 (Lateral Movement)：擴散到其他主機","行動 (Actions)：竊取或破壞目標資料"],"ans":0,"exp":"Kill Chain 階段序：偵蒐→武器化→投遞→漏洞利用→安裝→命令控制(C2)→行動。第一步是偵蒐。","insight":"核心概念是『越早的階段攔阻、防禦成本越低』——所以偵蒐階段就要減少對外暴露的資訊。與縱深防禦互補。","learn":{"label":"Lockheed Martin：Cyber Kill Chain","url":"https://www.lockheedmartin.com/en-us/capabilities/cyber/cyber-kill-chain.html"}},
    {"id":"S-02","ch":1,"topic":"MITRE ATT&CK","src":"0 課前基本認識（資安框架）","core":false,"diff":2,"supp":true,"kind":"supplement","q":"MITRE ATT&CK 是什麼？","options":["彙整真實攻擊者『戰術與技術』的知識庫，供防禦方對照與偵測","一套自動化的漏洞掃描與滲透測試工具","OWASP 維護的 Web 應用漏洞排名清單","政府強制企業遵守的資安法規標準"],"ans":0,"exp":"ATT&CK 用『戰術(為什麼)＋技術(怎麼做)』描述攻擊行為，藍隊常用它盤點偵測涵蓋度。","insight":"ATT&CK(行為知識庫) 與 Kill Chain(階段流程) 互補：一個描述『用了哪些手法』、一個描述『打到哪個階段』。","learn":{"label":"MITRE ATT&CK","url":"https://attack.mitre.org/"}},
    {"id":"S-03","ch":1,"topic":"GPT / AI","src":"0 課前基本認識（ChatGPT）","core":false,"diff":1,"supp":true,"kind":"supplement","card":"ChatGPT 的 GPT 是哪三個字的縮寫？","q":"ChatGPT 的『GPT』是哪三個字的縮寫？","options":["Generative Pre-trained Transformer（生成式預訓練轉換器）","General Purpose Technology（通用目的技術）","Global Protocol Translator（全球協定轉換器）","Guided Prompt Tuning（引導式提示調校）"],"ans":0,"exp":"G＝能生成新文字、P＝先用大量文本預訓練、T＝Transformer 架構。","insight":"理解它是『機率式生成』，就懂它為何會一本正經地說錯（幻覺）——用它輔助資安時要驗證，不能盡信。","learn":{"label":"OpenAI 介紹","url":"https://openai.com/index/chatgpt/"}},
    {"id":"S-04","ch":1,"topic":"AI 在資安","src":"0 課前基本認識（AI 應用）","core":false,"diff":2,"supp":true,"kind":"supplement","card":"AI（如 ChatGPT）在資安中扮演什麼角色？為什麼說是雙面刃？","q":"關於 AI（如 ChatGPT）在資安領域的角色，下列敘述何者最正確？","options":["是雙面刃：可助防禦方自動化偵測分析，也可能被攻擊者用來寫惡意程式或釣魚","只能用於防禦，攻擊者無法利用 AI","只會被攻擊者濫用，對防禦沒有幫助","與資安完全無關，只是聊天工具"],"ans":0,"exp":"課程用 sgpt 讓 AI 自動產生 Nmap 掃描語法示範『提升效率』；但同樣能力也能被用來生成釣魚郵件或後門。","insight":"攻防雙方都在用 AI。防禦要善用 AI 提升效率，也要警覺攻擊者用 AI 降低攻擊門檻——這正是課名『AI 應用實戰』的核心。","learn":{"label":"OWASP：LLM 應用風險","url":"https://owasp.org/www-project-top-10-for-large-language-model-applications/"}},
    {"id":"S-05","ch":1,"topic":"滲透測試方法","src":"0 課前基本認識（滲透測試）","core":false,"diff":2,"supp":true,"kind":"supplement","card":"滲透測試的黑箱／白箱／灰箱，差在測試者掌握多少資訊？","q":"滲透測試依『測試者事先掌握多少內部資訊』分類，下列配對何者正確？","options":["黑箱＝幾乎無內部資訊；白箱＝完整資訊；灰箱＝部分資訊","黑箱＝完整資訊；白箱＝無資訊；灰箱＝部分資訊","黑箱＝只測前端；白箱＝只測後端；灰箱＝只測資料庫","黑箱＝自動掃描；白箱＝人工測試；灰箱＝兩者混合"],"ans":0,"exp":"黑箱最貼近真實外部攻擊者、白箱最徹底（給原始碼與架構）、灰箱折衷。","insight":"這是滲透測試(1-37)的方法論細分。資訊越多測得越徹底但越不像真實外部攻擊，各有取捨。","learn":{"label":"OWASP 測試指南","url":"https://owasp.org/www-project-web-security-testing-guide/"}},
    {"id":"S-06","ch":2,"topic":"Windows 註冊表","src":"2.3 Windows系統操作（進階）","core":false,"diff":2,"supp":true,"kind":"supplement","card":"Windows 註冊表 (Registry) 在資安上為何重要？惡意程式常怎麼利用它？","q":"Windows 的『註冊表 (Registry)』在資安上為何重要？","options":["存放系統與程式設定，惡意程式常改『自動啟動』機碼取得持久性；可用 regedit 檢視","是防毒軟體專用的病毒特徵資料庫","負責加密整顆磁碟以保護開機前的資料","記錄所有網路連線的封包內容供稽核"],"ans":0,"exp":"註冊表的 Run/RunOnce 等自動啟動機碼，是惡意程式『開機就跑』的常見落腳處；regedit/reg 可檢視管理。","insight":"註冊表自啟動連到下一個大觀念『持久性』——防禦方會盯著這些自動啟動點找異常。","learn":{"label":"Microsoft：登錄機碼","url":"https://learn.microsoft.com/zh-tw/windows/win32/sysinfo/registry"}},
    {"id":"S-07","ch":2,"topic":"持久性","src":"2.3 Windows系統操作（進階）","core":false,"diff":3,"supp":true,"kind":"supplement","card":"攻擊者確保『重開機也能繼續存取』的手法叫什麼？常藏在哪？","q":"攻擊者入侵後想確保『重開機也能繼續存取』，這種手法統稱為？常見落腳處為何？","options":["持久性 (Persistence)：常藏在開機啟動項、排程任務、註冊表自啟動、服務中","橫向移動 (Lateral Movement)：跳到內網其他主機","權限提升 (Privilege Escalation)：取得更高的權限","資料外洩 (Exfiltration)：把竊得的資料傳出去"],"ans":0,"exp":"持久性＝『賴著不走』。防禦方用 Sysinternals 的 Autoruns 檢查所有自動啟動點、比對異常。","insight":"對應 Kill Chain 的『安裝(Installation)』階段。清除入侵不只砍掉惡意程式，還要挖出它的持久性落腳處。","learn":{"label":"MITRE ATT&CK：Persistence","url":"https://attack.mitre.org/tactics/TA0003/"}},
    {"id":"S-08","ch":2,"topic":"橫向移動","src":"2.3 Windows系統操作（進階）","core":false,"diff":3,"supp":true,"kind":"supplement","card":"攻下一台電腦後跳到內網其他主機，叫什麼？常見手法？","q":"攻擊者攻下一台電腦後，設法跳到內網『其他主機』擴大戰果，這稱為？常見手法為何？","options":["橫向移動 (Lateral Movement)：常靠竊取憑證、傳遞雜湊 (Pass-the-Hash)","持久性 (Persistence)：確保重開機後仍可存取","偵蒐 (Reconnaissance)：蒐集目標的公開資訊","阻斷服務 (DoS)：以大量流量癱瘓目標服務"],"ans":0,"exp":"橫向移動是內網滲透核心——攻下一台後用竊得的憑證登入其他主機。","insight":"這正是『網路分段(TR-3)』與『最小權限』重要的原因：分段與最小權限能大幅限制橫向移動的範圍。","learn":{"label":"MITRE ATT&CK：Lateral Movement","url":"https://attack.mitre.org/tactics/TA0008/"}}
  ]
};
